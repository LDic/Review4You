      ...
      <div class="col" style="margin-bottom:20px;">
        ...
        <tbody>
          <tr style="font-weight: bold; color: #D64B43;">
            <th scope="row">1st</th>
            <td v-if="summaryResult.length!=0">{{ summaryResult.keywordCloud[0] }}</td>
          </tr>
          <tr style="font-weight: bold; color: #D64B43;">
            <th scope="row">2nd</th>
            <td v-if="summaryResult.length!=0">{{ summaryResult.keywordCloud[1] }}</td>
          </tr>
          <tr style="font-weight: bold; color: #D64B43;">
            <th scope="row">3rd</th>
            <td v-if="summaryResult.length!=0">{{ summaryResult.keywordCloud[2] }}</td>
          </tr>
          <tr>
            <th scope="row">4th</th>
            <td v-if="summaryResult.length!=0">{{ summaryResult.keywordCloud[3] }}</td>
          </tr>
          <tr>
            <th scope="row">5th</th>
            <td v-if="summaryResult.length!=0">{{ summaryResult.keywordCloud[4] }}</td>
          </tr>
          <tr>
            <th scope="row">6th</th>
            <td v-if="summaryResult.length!=0">{{ summaryResult.keywordCloud[5] }}</td>
          </tr>
          <tr>
            <th scope="row">7th</th>
            <td v-if="summaryResult.length!=0">{{ summaryResult.keywordCloud[6] }}</td>
          </tr>
          <tr>
            <th scope="row">8th</th>
            <td v-if="summaryResult.length!=0">{{ summaryResult.keywordCloud[7] }}</td>
          </tr>
          <tr>
            <th scope="row">9th</th>
            <td v-if="summaryResult.length!=0">{{ summaryResult.keywordCloud[8] }}</td>
          </tr>
          <tr>
            <th scope="row">10th</th>
            <td v-if="summaryResult.length!=0">{{ summaryResult.keywordCloud[9] }}</td>
          </tr>
        </tbody>
      </div>
        ...
        <div class="row">
          <div class="col-4 col-sm-4">
            ...
            <tbody>
              <tr style="font-weight: bold; color: #D64B43;">
                <th scope="row">1st</th>
                <td v-if="summaryResult.length!=0">{{ summaryResult.sentKeyCloud[0] }}</td>
              </tr>
              <tr style="font-weight: bold; color: #D64B43;">
                <th scope="row">2nd</th>
                <td v-if="summaryResult.length!=0">{{ summaryResult.sentKeyCloud[1] }}</td>
              </tr>
              <tr style="font-weight: bold; color: #D64B43;">
                <th scope="row">3rd</th>
                <td v-if="summaryResult.length!=0">{{ summaryResult.sentKeyCloud[2] }}</td>
              </tr>
              <tr>
                <th scope="row">4th</th>
                <td v-if="summaryResult.length!=0">{{ summaryResult.sentKeyCloud[3] }}</td>
              </tr>
              <tr>
                <th scope="row">5th</th>
                <td v-if="summaryResult.length!=0">{{ summaryResult.sentKeyCloud[4] }}</td>
              </tr>
            </tbody>
          </div>
          ...
          <div class="col-4 col-sm-4">
            ...
            <tbody>
              <tr style="font-weight: bold; color: #D64B43;">
                <th scope="row">1st</th>
                <td v-if="summaryResult.length!=0">{{ summaryResult.sentKeyCloud[5] }}</td>
              </tr>
              <tr style="font-weight: bold; color: #D64B43;">
                <th scope="row">2nd</th>
                <td v-if="summaryResult.length!=0">{{ summaryResult.sentKeyCloud[6] }}</td>
              </tr>
              <tr style="font-weight: bold; color: #D64B43;">
                <th scope="row">3rd</th>
                <td v-if="summaryResult.length!=0">{{ summaryResult.sentKeyCloud[7] }}</td>
              </tr>
              <tr>
                <th scope="row">4th</th>
                <td v-if="summaryResult.length!=0">{{ summaryResult.sentKeyCloud[8] }}</td>
              </tr>
              <tr>
                <th scope="row">5th</th>
                <td v-if="summaryResult.length!=0">{{ summaryResult.sentKeyCloud[9] }}</td>
              </tr>
            </tbody>
          </div>
          ...
          <div class="col-4 col-sm-4">
            ...
            <tbody>
              <tr style="font-weight: bold; color: #D64B43;">
                <th scope="row">1st</th>
                <td v-if="summaryResult.length!=0">{{ summaryResult.sentKeyCloud[10] }}</td>
              </tr>
              <tr style="font-weight: bold; color: #D64B43;">
                <th scope="row">2nd</th>
                <td v-if="summaryResult.length!=0">{{ summaryResult.sentKeyCloud[11] }}</td>
              </tr>
              <tr style="font-weight: bold; color: #D64B43;">
                <th scope="row">3rd</th>
                <td v-if="summaryResult.length!=0">{{ summaryResult.sentKeyCloud[12] }}</td>
              </tr>
              <tr>
                <th scope="row">4th</th>
                <td v-if="summaryResult.length!=0">{{ summaryResult.sentKeyCloud[13] }}</td>
              </tr>
              <tr>
                <th scope="row">5th</th>
                <td v-if="summaryResult.length!=0">{{ summaryResult.sentKeyCloud[14] }}</td>
              </tr>
            </tbody>
          </div>
