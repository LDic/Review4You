      ...
      <div class = "main-board">
        <div class = "grid-container">
          ...
          <div class = "grid-sub-header">
            <div class = "wrapper">
                <button class="btn-home" v-on:click="gotoHome()">Home</button>
                <button class="btn-search" v-on:click="gotoSearch()">Search</button>
          ...
          <div class = "grid-intent" v-if="summaryResult.length!=0">
            ...
            <table class="table-results">
              ...
              <tr>
                <td>Complaint</td>
                <td class = "content">{{ ratio_intent('complaint') }}%</td>
              </tr>
            </table>
          </div>
        </div>
